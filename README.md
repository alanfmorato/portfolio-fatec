...
<p1>Desenvolvimento de Assistentes Virtuais: Adquiri habilidades de programação em Python, desenvolvendo uma assistente virtual capaz de reconhecer comandos de voz e executar diversas funções.</p1>

<p1>Processamento de Linguagem Natural: Trabalhei com bibliotecas de reconhecimento de voz e processamento de linguagem natural, aprimorando minha compreensão e aplicação dessas tecnologias para entender e responder a comandos de voz.</p1>

<p1>Integração de APIs: Integrei a assistente virtual com diversas APIs para fornecer respostas e funcionalidades adicionais, como consulta sobre o clima.</p1>

</details>
<h3>Soft Skills</h3>
<details>
  <summary><b>Clique para ver a lista de soft skills</b></summary>
<p1>Análise Crítica: Avaliar e otimizar o desempenho do sistema de reconhecimento de voz, garantindo precisão e rapidez nas respostas, demonstrou minha capacidade de análise crítica e refinamento técnico.</p1>

<p1>Colaboração em Código: Participar ativamente de revisões de código e contribuir para a melhoria contínua do projeto, trabalhando de forma colaborativa com outros desenvolvedores e recebendo feedback construtivo.</p1>

<p1>Adaptabilidade: Lidar com mudanças de requisitos e integrar novas funcionalidades de forma eficiente ilustrou minha capacidade de se adaptar a ambientes de desenvolvimento dinâmicos, uma habilidade valiosa no cenário de software.</p1>
...
<h3></h3>
<details>
  <summary><b>Implementação de Reconhecimento de Voz e Integração com YouTube</b></summary>
  <br>
  <p>Desenvolvi uma funcionalidade para a assistente virtual que permite realizar buscas no YouTube com base em comandos de voz do usuário. Utilizando as bibliotecas <code>speech_recognition</code>, <code>pyttsx3</code> e <code>pywhatkit</code>, criei um sistema eficiente para reconhecer, processar e executar comandos de voz, proporcionando uma experiência de usuário fluida e intuitiva.</p>
...
<details>
  ...
  <summary><b>Implementação de Calculadora por Comandos de Voz</b></summary>
  <br>
  <p>Desenvolvi uma funcionalidade de calculadora por comandos de voz para a assistente virtual. Utilizando as bibliotecas <code>speech_recognition</code> e <code>pyttsx3</code>, criei um sistema que permite ao usuário realizar cálculos matemáticos simples apenas falando os números e a operação desejada. Esta funcionalidade oferece uma maneira conveniente e intuitiva de realizar operações matemáticas sem a necessidade de inserir manualmente os números em um teclado.</p>
